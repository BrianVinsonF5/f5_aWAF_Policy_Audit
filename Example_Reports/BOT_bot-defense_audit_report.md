# Bot Defense Profile Compliance Report for `/Common/bot-defense` on `ip-10-1-1-4.us-west-2.compute.internal` (10.1.1.4)

**Source Device:** `ip-10-1-1-4.us-west-2.compute.internal` (10.1.1.4)

## Profile: `/Common/bot-defense`

- **Partition:** Common
- **Enforcement Mode:** transparent
- **Baseline Profile:** bot_baseline.xml
- **Audit Date:** 2026-04-03T19:47:38Z
- **Compliance Score:** 82.5% — **FAIL** (threshold: 90%)
...
| Advanced | Device ID Mode | generate-after-access | none | ✗ |
...
- **Extra elements (in target, not in baseline):** 2
...
### 5. bot-defense.overrides.whitelist: apple_touch_1
- **Attribute:** `present`
- **Baseline:** Disabled
- **This Policy:** Enabled
- **Impact:** Override entry 'apple_touch_1' was added in 'Whitelist' on target profile.

### 6. bot-defense.overrides.whitelist: favicon_1
- **Attribute:** `present`
- **Baseline:** Disabled
- **This Policy:** Enabled
